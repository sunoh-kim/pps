...
from model.optimizer.lr_scheduler.fairseq_lr_scheduler import FairseqLRScheduler
from model.optimizer.lr_scheduler.inverse_square_root_schedule import InverseSquareRootSchedule
...
for file in os.listdir(os.path.dirname(__file__)):
    if file.endswith('.py') and not file.startswith('_'):
        ...
        importlib.import_module('model.optimizer.lr_scheduler.' + module)
